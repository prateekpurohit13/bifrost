...
func paritySpecs() []parityLogSpec {
	return []parityLogSpec{
		{id: "p1", offsetSec: 100, object: "chat.completion", provider: "openai", model: "gpt-4o", status: "success",
			...
			session:    ComplexitySessionLogFields{ComplexitySessionID: strPtrP("session-hash-1"), ComplexitySessionMode: strPtrP("pinned"), ComplexitySessionTierSource: strPtrP("memoised"), ComplexitySessionSwitchCount: intPtrP(0)},
		...
		{id: "p2", offsetSec: 90, object: "chat.completion", provider: "openai", model: "gpt-4o", status: "success",
			...
			session:    ComplexitySessionLogFields{ComplexitySessionID: strPtrP("session-hash-2"), ComplexitySessionMode: strPtrP("cache_aware"), ComplexitySessionTierSource: strPtrP("held"), ComplexitySessionSwitchCount: intPtrP(2)},
