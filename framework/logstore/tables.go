...
type ComplexitySessionLogFields struct {
	ComplexitySessionID          *string `gorm:"type:varchar(64)" json:"complexity_session_id,omitempty"`                                 // Tenant-scoped hash; never the caller's raw identity and deliberately unindexed
