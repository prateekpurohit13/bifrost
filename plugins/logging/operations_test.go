...
func TestPostLLMHookNoPendingErrorPreservesMetadata(t *testing.T) {
	...
	ctx.SetValue(schemas.BifrostContextKeyGovernanceComplexitySessionID, "hashed-session-id")
	...
	if logEntry.ComplexitySessionID == nil || *logEntry.ComplexitySessionID != "hashed-session-id" {
...
func TestPostLLMHookCapturesComplexityRoutingContext(t *testing.T) {
	...
	if entry.ComplexitySessionID == nil || *entry.ComplexitySessionID != "hashed-session-id" {
